...
public class MarkerServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) {
    ...
    String content = Jsoup.clean(request.getParameter("content"), Safelist.none());
    String date = Jsoup.clean(request.getParameter("date"), Safelist.none());

    Marker marker = new Marker(lat, lng, title, content, date);
    storeMarker(marker);
  }
  ...
  public void storeMarker(Marker marker) {
    ...
    FullEntity markerEntity =
        Entity.newBuilder(keyFactory.newKey())
            ...
            .set("title", marker.getTitle())
            .set("content", marker.getContent())
            .set("date", marker.getDate())
            .build();
